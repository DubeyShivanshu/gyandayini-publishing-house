...
//     if (!otpOk) { toast.error('Please verify your email'); return }
...
//                 <input className="input-field" type="email" required value={form.customerEmail} onChange={e => set('customerEmail', e.target.value)} placeholder="your@email.com" />
//               </div>
...
//                 if (!form.customerName || !form.customerPhone || !form.customerEmail) { toast.error('Name, phone and email are required'); return }
...
//           {/* Step 2: Captcha + Email OTP */}
//           {step === 2 && (
//             <div className="card p-6 fade-in-up space-y-6">
//               <h2 className="font-display text-xl font-bold">Verify Your Identity</h2>
//               <p className="text-sm text-gray-600 font-body">We verify to prevent fake orders and protect genuine customers.</p>

//               <CaptchaInput onVerified={() => setCaptchaOk(true)} />

//               <div>
//                 <label className="label">Email OTP Verification *</label>
//                 <EmailOTPInput email={form.customerEmail} onVerified={() => setOtpOk(true)} />
//               </div>

//               <div className="flex gap-3">
//                 <button type="button" onClick={() => setStep(1)} className="btn-outline flex-1">← Back</button>
//                 <button type="button" disabled={!captchaOk || !otpOk} onClick={() => setStep(3)}
//                   className={`flex-1 font-bold py-3 px-6 rounded-lg transition-all ${captchaOk && otpOk ? 'btn-primary' : 'bg-gray-200 text-gray-400 cursor-not-allowed'}`}>
//                   Next: Review & Submit →
//                 </button>
//               </div>
//             </div>
...
//                 <div className="flex justify-between"><span className="text-gray-500">Email</span><span className="font-bold">{form.customerEmail}</span></div>
