        ...
        {step === 3 && (
          <div className="card p-6 fade-in-up space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button disabled={!captchaOk || !otpOk} onClick={() => setStep(4)}
                className={`flex-1 font-bold py-3 px-6 rounded-lg ${captchaOk && otpOk ? 'btn-primary' : 'bg-gray-200 text-gray-400 cursor-not-allowed'}`}>
                Review →
              </button>
            </div>
          </div>
